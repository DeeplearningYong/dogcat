...
in_db.close()
print  'train cats count: '+ str(count_train_cats)
print  'train dogs count: '+ str(count_train_dogs)
...
with in_db.begin(write=True) as in_txn:
    for in_idx, img_path in enumerate(train_data):
        ...
        #print '{:0>5d}'.format(in_idx) + ':' + img_path
in_db.close()
print  'test cats count: '+ str(count_test_cats)
print  'test dogs count: '+ str(count_test_dogs)
